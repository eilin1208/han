...
func ExamplePrint() {
	...
	// Output like:
	// PRINT AT github.com/hanlin1123/go-boxs/goutil/dump.ExamplePrint(LINE 14):
	// int(23)
	// []string{"ab", "cd"}
	// []int [
	//   1,
...
func TestPrint(t *testing.T) {
	...
	// print position
	Fprint(buf, 123)
	// "PRINT AT github.com/hanlin1123/go-boxs/goutil/dump.TestPrint(dump_test.go:65)"
	str := buf.String()
	is.Contains(str, "PRINT AT github.com/hanlin1123/go-boxs/goutil/dump.TestPrint(dump_test.go:")
...
func TestStruct_CannotExportField(t *testing.T) {
	...
	// OUT:
	// PRINT AT github.com/hanlin1123/go-boxs/goutil/dump.TestStruct_CannotExportField(dump_test.go:202)
